...
class TrainingModule:
    def __init__(self, chosen_algorithm = "logistic_regression"):
        ...
        self.__mlp = MLPClassifier(activation = "logistic", verbose = True, random_state = 1)
        ...
        # self.__positive_examples_count = 5000
        # self.__negative_examples_count = 5000
    ...
    def run(self):
        ...
        if self.__chosen_algorithm == "logistic_regression":
            ...
            solvers = [ "sgd", "adam" ]
            regularization_values = [ 0.00005, 0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.05, 0.1, 0.2, 0.5, 1.0, 2.0, 5.0 ]
            hidden_layers = [ (100,), (1000,), (2000,), (5000,), (100, 100), (1000, 1000), (2000, 2000), (5000, 5000)]
    ...
    def __train(self, learning_rate = "optimal", regularization = 0.0001, iterations = 1000, hidden_layer = (100,), solver = "sgd"):
        print("\n*--------------------TRAINING--------------------*")
        ...
        if self.__chosen_algorithm == "logistic_regression":
            self.__log_reg = SGDClassifier(loss = "log", eta0 = 1.0)
        ...
        while positive_images_processed < self.__training_set_positive_examples_count or negative_images_processed < self.__training_set_negative_examples_count:
            ...
            # Learning from batch
            if self.__chosen_algorithm == "logistic_regression":
                self.__log_reg.partial_fit(X_training, y_training, classes = self.__classes)
            elif self.__chosen_algorithm == "neural_network":
                self.__mlp.partial_fit(X_training, y_training, classes = self.__classes)
